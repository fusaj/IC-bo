...
const ArchivosIndexPage = () => {
  ...
  let pageInfo = {
    title: "Archivos",
    subtitle:
      "Acá se puede visualizar la lista de archivos que representan los balances presentados por BNA País, las Filiales del exterior y las empresas Subsidiarias",
  };
